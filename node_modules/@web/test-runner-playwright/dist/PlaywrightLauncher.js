...
const PlaywrightLauncherPage_js_1 = require("./PlaywrightLauncherPage.js");
...
class PlaywrightLauncher {
    ...
    async createNewPage(browser) {
        ...
        return new PlaywrightLauncherPage_js_1.PlaywrightLauncherPage(this.config, this.product, this.testFiles, playwrightContext, playwrightPage);
    }
